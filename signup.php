    ...
    <div class="signup-form">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" class="form-control" name="user_name" placeholder="John Doe" autocomplete="off" required>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="text-center small" style="color: indianred;">Already have an account? <a href="signin.php">Sign In</a></div>
    </div>
</body>
